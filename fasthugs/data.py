...
__all__ = ['get_splits', 'TextGetter', 'KeyGetter', 'find_first', 'split_by_sep', 'TokTransform', 'TokBatchTransform',
           'PadBatchTransform', 'untuple', 'to_tuple', 'LMBatchTfm', 'Undict', 'UndictS2S', 'TransformersTextBlock',
           'TransformersLMBlock', 'tokenize', 'group_texts', 'RougeMetric']
...
# Cell
class RougeMetric(Callback):
    order = TransCallback.order + 2
    run_train, run_valid = False, True
    def __init__(self, tokenizer, argmax=True, agg='mid', measure='fmeasure',
    ...
    def after_pred(self):
        ...
        if self.argmax: preds = preds.argmax(-1)
